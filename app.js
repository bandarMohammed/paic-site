...
const I18N = {
  ar: {
    ...
    'home.badge': 'PAIC · 2026',
    'home.title1': 'برمجة',
    'home.title2': '. ذكاء اصطناعي',
    'home.title3': '. مستقبل.',
    'home.subtitle': 'نادي البرمجة والذكاء الاصطناعي — مجتمع للمبدعين، يقدم لك خصومات حصرية في أفضل المطاعم والكوفيهات.',
    ...
    'offers.subtitle': 'خصومات حصرية لأعضاء النادي عبر شركاء النادي',
    ...
    'about.subtitle': 'نادي البرمجة والذكاء الاصطناعي',
    'about.missionTitle': 'مهمتنا',
    'about.missionDesc': 'تمكين الطلاب من إتقان مهارات البرمجة والذكاء الاصطناعي عبر ورش عمل، مشاريع، وفعاليات تجمع المبدعين تحت سقف واحد.',
  ...
  en: {
    ...
    'home.title2': '. AI',
    'home.title3': '. Future.',
    'home.subtitle': 'Programming & AI Club — a community for innovators, offering you exclusive discounts at the best restaurants and cafés.',
    ...
    'offers.subtitle': 'Exclusive discounts for club members through partners',
    ...
    'about.subtitle': 'Programming & Artificial Intelligence Club',
    'about.missionTitle': 'Our Mission',
    'about.missionDesc': 'Empowering students to master programming and AI skills through workshops, projects, and events that bring innovators under one roof.',
...
function setupRealtimeUpdates() {
  ...
  realtimeUnsubscribe = window.DB.subscribe(() => {
    loadOffers();
  });
}
...
window.openMap = function(id) {
  ...
  if (offer.lat && offer.lng) {
    ...
    const query = `${offer.name_ar || offer.name_en} الطائف`;
...
window.deleteOffer = async function(id) {
  ...
  if (!window.DB) return;
  const ok = await window.DB.delete(id);
  if (!ok) {
    toast(DB_ERROR_MSG[State.lang] || DB_ERROR_MSG.en);
    return;
  }
